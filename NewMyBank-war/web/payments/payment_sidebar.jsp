...
<section class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li style="background-color: #f9f9f9" id="moneyDepType3">
            <a href="money_translate.jsp?moneyDepType=3">
        ...
        <li style="background-color: #f9f9f9" id="creditorDebtor114">
            <a href="creditor_debtor.jsp?index=<%=Security.encrypt("114")%>">
        ...
        <li style="background-color: #f9f9f9" id="creditorDebtor115">
            <a href="creditor_debtor.jsp?index=<%=Security.encrypt("115")%>">
        ...
        <li class="treeview" id="custDetails">
            ...
            <ul class="treeview-menu" id="custDetailsUl">
                ...
                <li id="custDetails2"><a href="company_details.jsp" style="margin-left: 0px;font-size: 13px;"><i class="fa fa-angle-double-right"></i>ආයතනික</a></li>
            </ul>
        </li>
        <li class="treeview" id="moneyDepTypeLi">
            ...
            <ul class="treeview-menu" id="moneyDepTypeUl">
                ...
                <li id="moneyDepType4"><a href="savings_crdr.jsp?index=<%=Security.encrypt("121")%>" style="margin-left: 0px;font-size: 13px;"><i class="fa fa-angle-double-right"></i>ඉතුරුම් ගිණුම බැර</a></li>
                <li id="moneyDepType5"><a href="savings_crdr.jsp?index=<%=Security.encrypt("151")%>" style="margin-left: 0px;font-size: 13px;"><i class="fa fa-angle-double-right"></i>ඉතුරුම් ගිණුම හර</a></li>
        ...
        <li class="treeview" id="creditorDebtorLi">
            ...
            <ul class="treeview-menu" id="creditorDebtorUl">
                <li id="savingsCrdr121"><a href="savings_crdr.jsp?index=<%=Security.encrypt("121")%>" style="margin-left: 0px;font-size: 13px;"><i class="fa fa-angle-double-right small"></i>හර සටහන්</a></li>
                <li id="savingsCrdr151"><a href="savings_crdr.jsp?index=<%=Security.encrypt("151")%>" style="margin-left: 0px;font-size: 13px;"><i class="fa fa-angle-double-right small"></i>බැර සටහන්</a></li>
            </ul>
        </li>
        <li id="commonLegger">
            <a href="common_legger.jsp">
