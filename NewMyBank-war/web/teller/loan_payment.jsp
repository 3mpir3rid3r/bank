                                ...
                                <div class="panel box box-info bg-color">
                                    ...
                                    <div class="box-body" style="height: 50px">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input style="height: 30px;" type="text" class="form-control input-sm text-right box-field convertSinhalaIskolaPotha" placeholder="0.00" name="cReceiptNo" id="cReceiptNo" data="validate" data-type="number"> 
                                            </div>
                                            <label class="col-sm-2 text-right input-sm">භා. බිල් අංකය :</label>
                                            <div class="col-md-2">
                                                <input style="height: 30px;" type="text" class="form-control input-sm text-right box-field convertSinhalaIskolaPotha" placeholder="0.00" name="cReceiptNo2" id="cReceiptNo2" data="validate" data-type="number">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="panel box box-info bg-color">
                                    ...
                                    <div class="box-body" style="margin-bottom:-25px">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field convertSinhalaIskolaPotha" placeholder="0.00"  name="nPaidStationary" id="nPaidStationary" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field convertSinhalaIskolaPotha" placeholder="0.00" name="nPaidPostage" id="nPaidPostage" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field" placeholder="0.00" name="nPaidCaurtFees" id="nPaidCaurtFees" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field" placeholder="0.00" name="nPaidArbitrationFees" id="nPaidArbitrationFees" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field" placeholder="0.00" name="nPaidIntValue" id="nPaidIntValue" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field" placeholder="0.00" name="nPaidPenaltyValue" id="nPaidPenaltyValue"data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field" placeholder="0.00" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                        ...
                                        <div class="form-group" style="margin-top:-15px;">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" class="form-control input-sm text-right box-field" placeholder="0.00" name="nPaidCapitalVal" id="nPaidCapitalVal" data="validate" data-type="decimal">
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin-top:-15px;">
                                            <div class="col-sm-12">
                                ...
                                <div class="panel box box-info bg-color">
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <label class="col-sm-3 input-sm text-left f-size13 bg-top10"  data="validate" data-type="decimal"><%=nIssuedAmount%></label>
                                            <label class="col-sm-3 input-sm text-right f-size13 bg-top10" >ඉතිරිය :</label>
                                            <label class="col-sm-2 input-sm text-left f-size13 bg-top10"  data="validate" data-type="decimal"><%=nBalanceToIssue%></label>
                                            ...
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nInstallmentAmountAdj%></label>

                                            <label class="col-sm-4 input-sm text-right box-label" >අයවී ඇති මුදල :</label>
                                            <label class="col-sm-3 input-sm text-left box-label" data="validate" data-type="decimal"><%=nTotRecvCapital%></label>
                                            <label class="col-sm-3 input-sm text-right box-label" >වාරික :</label>
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nTotRecvInstallment%></label>

                                            <label class="col-sm-4 input-sm text-right box-label" >අයවිය යුතු මුදල :</label>
                                            <label class="col-sm-3 input-sm text-left box-label" data="validate" data-type="decimal"><%=nShouldRecvCapital%></label>
                                            <label class="col-sm-3 input-sm text-right box-label" >වාරික :</label>
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nShouldRecvInstallment%></label>

                                            <label class="col-sm-4 input-sm text-right box-label" >අයවී ඇති පොළිය :</label>
                                            <label class="col-sm-3 input-sm text-left box-label" data="validate" data-type="decimal"><%=nTotRecvInterest%></label>
                                            <label class="col-sm-3 input-sm text-right box-label">අයවිය යුතු පොළිය :</label>
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nShouldRecvInterest%></label>

                                            <label class="col-sm-4 input-sm text-right box-label">ගෙවීමට ඇති මුදල :</label>
                                            <label class="col-sm-3 input-sm text-left box-label" data="validate" data-type="decimal"><%=nLonBalanceAmount%></label>
                                            <label class="col-sm-3 input-sm text-right box-label">වාරික :</label>
                                            ...
                                            <label class="col-sm-3 input-sm text-left box-label" data="validate" data-type="decimal"><%=nToDateDueCapital%></label>
                                            <label class="col-sm-3 input-sm text-right box-label">වාරික :</label>
                                            ...
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nToDateIntValueRound%></label>
                                            <label class="col-sm-1 input-sm text-right box-label" ></label>
                                            <label class="col-sm-3 input-sm text-right box-label" data="validate" data-type="decimal">හිඟ පොළිය :</label>
                                            ...
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nToDatePanaltyIntSubjectAmount%></label>
                                            <label class="col-sm-1 input-sm text-right box-label" ></label>
                                            <label class="col-sm-3 input-sm text-right box-label" >දඩ පොළී :</label>
                                            <label class="col-sm-2 input-sm text-left box-label" data="validate" data-type="decimal"><%=nToDatePanaltyIntValue%></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control input-sm text-right" placeholder="0.00" name="nPaymentVal" id="nPaymentVal" style="font-size: 14px" data="validate" data-type="decimal">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
