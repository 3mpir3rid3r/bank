<%-- 
    Document   : savings_crdr
    Created on : Apr 4, 2015, 10:51:23 PM
    Author     : mmh
--%>
    ...
    <body class="skin-blue  pace-done fixed" style="background-image: linear-gradient(#54b4eb, #2fa4e7 60%, #1d9ce5)">
        ...
        <%            String title = "";
            ...
            if (request.getParameter("index") != null) {
                ...
                if ("121".equals(index)) {
                    title = "ඉතුරුම් ගිණුම බැර";
                    tHead = "බැර";
                } else if ("151".equals(index)) {
                    tHead = "හර";
                    title = "ඉතුරුම් ගිණුම හර";
                }
            ...
            if (request.getParameter("alert") != null) {
                if ("success".equals(Security.decrypt(request.getParameter("alert").replace(" ", "+")))) {
                    ...
                    alert = Alerts.warningAlert("Error", "The table is empty", "");
                }
            }
        %>
        <!--..............................-->
            ...
            <aside class="right-side">
                ...
                <%
                    ...
                    if (request.getSession().getAttribute("branch") == null) {
                        ...
                        branchName = bankBranch1.getCSubSectionNameSin();
                    }
                                        ...
                                        <form class="form-horizontal bg-top" method="get" action="../SaveSavingsCreditorServlet" onsubmit="create(this);
                                            ...
                                            <div class="panel-body" style="margin-bottom: 0px;height: 500px;">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="branch" class="form-control input-sm convertSinhalaAmali" value="<%=branchName%>" disabled="">                                                                                    
                                                    </div>
                                                ...
                                                <div class="form-group bg-top">
                                                    ...
                                                    <div class="col-md-10">
                                                        <textarea class="form-control input-sm" name="cRemarks" id="cRemarks"><%=cRemarks%></textarea>
                                                    </div>                                                    
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group" style="margin-bottom: 40px;">
                                                        <input type="hidden" value="<%=pkOfAcc4Id%>" id="pkOfAcc4Id" name="pkOfAcc4Id">                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                        ...
                                                        <ul id="treeDemo" class="ztree" style="width: auto;height:200px;">
                                                            <table class="table table-bordered table-hover" id="T">
                                                                <tbody>
                                                                    ...
                                                                    %>
                                                                    <tr>
                                                                        <td><a  class="btn btn-danger btn-sm" href="../CrDrSearchServlet?view=delete&id=<%=cdt.getRow1()%>&pageId=2">Delete</a></td>
                                                                        <td><%=cdt.getRow1()%></td>
                                                                        <td><%=cdt.getRow2()%></td>
                                                                        <td><%=cdt.getRow3()%></td>
                                                                        <td><%=cdt.getRow4()%></td>
...
//                                                                }
                                                                ...
                                                                function addRow(tableID) {
                                                                    ...
                                                                    window.location = '../CrDrSearchServlet?view=addRow&cell2=' + cell2 + '&cell3=' + cell3 + '&cell4=' + cell4 + '&cell5=' + cell5 + '&pageId=2';
                                                                }
...
////                                                            bool = false;
                                                                ...
                                                                function goCrDr(go) {
                                                                    ...
                                                                    if (go === '1') {
                                                                        window.location = '../CrDrSearchServlet?view=viewacc1&pageId=2';
                                                                        ;
                                                                    }
                                                                    if (go === '2') {
                                                                        window.location = '../CrDrSearchServlet?view=viewacc2&cDescription=' + cDescription + '&cReceiptNo=' + cReceiptNo + '&dTrnDate=' + dTrnDate + '&cChequeNo=' + cChequeNo + '&dChequeDate=' + dChequeDate + '&cCustomerName=' + cCustomerName + '&cRemarks=' + cRemarks + '&pageId=2';
                                                                    }
//                                                            if (go === '3') {
//                                                                window.location = '../CrDrSearchServlet?view=viewacc3&cDescription'+cDescription+'&cReceiptNo='+cReceiptNo+'&dTrnDate='+dTrnDate+'&cChequeNo='+cChequeNo+'&dChequeDate='+dChequeDate+'&cCustomerName'+cCustomerName+'&cRemarks'+cRemarks;
//                                                            }
