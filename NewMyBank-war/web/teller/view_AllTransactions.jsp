...
<html>
    <head>
        ...
        <title>Teller | View All Transactions</title>
                                            ...
                                            <div class="col-md-12">  
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-lg-12">
                                                        <span class="input-group-addon">සිට :&nbsp;&nbsp;<input  type="date" name="allcustomers" style="border-radius: none;"></span>
                                                        <span class="input-group-addon">දක්වා :&nbsp;&nbsp;<input  type="date" name="allcustomers"></span>
                                                        
                                                        
                                                        <span class="input-group-addon">ශාඛාව :&nbsp;&nbsp;
                                                            <select>
                                                                <option>aaaa</option>
                                                                <option>bbb</option>
                                                            </select>
                                                    ...
                                                    <div class="input-group col-lg-12">
                                                        <span class="input-group-addon">ස්වභාවය :&nbsp;&nbsp;
                                                            <select>
                                                                <option>විෂය ලිපිකරු පිළියල කළ</option>
                                                                <option>පොත් තබන්නා පරීක්ෂා කළ</option>
                                                            </select>
                                                        </span>
                                                        <span class="input-group-addon">වර්ගය :&nbsp;&nbsp;
                                                            <select>
                                                                <option>aaaa</option>
                                                                <option>bbb</option>
                                                            </select>
