                            ...
                            <div class="panel box box-info bg-color bg-top" style="height: 500px">
                                ...
                                <div class="box-body">
                                    <div style="height: 200px">
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>ණයහිමි ගෙවීම්</label></button>
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>වෙනත් ගෙවීම්</label></button>
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>ගැනුම් අත්තිකාරම්</label></button>
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>වෙනත් අත්තිකාරම්</label></button>
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>චෙක් සොයන්න</label></button>
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>චෙක් මොඩියුල්</label></button>
                                        <button type="button" class="btn btn-sm btn-block" onclick="" style="background-color: #1F9DE5;color: white"><label>Our Num</label></button>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="margin-top: -7px">
                                                <table id="depositTable" class="cell-border compact" cellspacing="0" width="100%">
                                                    <thead>
                                                        <tr style="font-size: 13px;background-color:  #1F9DE5">
