...
<%@page import="com.nbs.common.originalNumToLetter"%>
...
//                        request.getSession().removeAttribute("depositCustomer");
                                                ...
                                                <div class="box-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-10">
                                                                <input  required type="text" class="form-control input-sm convertSinhalaIskolaPotha" id="cFullName" name="cFullName" placeholder="සම්පූර්ණ නම" value="<%=cFullName%>" data="validate" data-type="letterS"/>
                                                            </div>
                                                        </div><br>  
                                                        <div class="form-group">
                                                            <label class="col-sm-2 input-sm text-right">ලිපිනය 1 :</label>
                                                            <div class="col-md-4">
                                                                <input  required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha" id="cPAddLine1" name="cPAddLine1" placeholder="ලිපිනය 1" value="<%=cPAddLine1%>" data="validate" data-type="address" data-line="line-1"/>
                                                            </div> 
                                                            <label class="col-sm-2 input-sm text-right">ලිපිනය 2 :</label>
                                                            <div class="col-md-4">
                                                                <input  type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha" id="cPAddLine2" name="cPAddLine2" placeholder="ලිපිනය 2" value="<%=cPAddLine2%>" data="validate" data-type="address" data-line="line-2"/>
                                                            </div> 
                                                        </div> <br> 
                                                        <div class="form-group">
                                                            <label class="col-sm-2 input-sm text-right">ලිපිනය 3 :</label>
                                                            <div class="col-md-4">
                                                                <input  type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha" id="cPAddLine3" name="cPAddLine3" placeholder="ලිපිනය 3" value="<%=cPAddLine3%>" data="validate" data-type="address" data-line="line-3"/>
                                                            </div> 
                                                            <label class="col-sm-2 input-sm text-right">ලිපිනය 4 :</label>
                                                            <div class="col-md-4">
                                                                <input  type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha" id="cPAddLine4" name="cPAddLine4" placeholder="ලිපිනය 4" value="<%=cPAddLine4%>" data="validate" data-type="address" data-line="line-4"/>
                                                            </div> 
                                                        </div> <br> 
                                                        <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <table id="dataTable" class="  table-bordered table-hover text-center col-lg-12">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <th> <input type="text" class="form-control input-sm col-lg-6 input-sm convertSinhalaIskolaPotha number" name="col3" id="col3" data="validate" data-type="number"/></th>
                                                                    <th> 
                                                                        <!--                                                            <div class="input-group">-->
                                        ...
                                        <div class="box-body" id="setSizeDiv">
                                            <div class="row">
                                                ...
                                                <div id="hiddenDataDiv1" class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number"  placeholder="ශුද්ධ රන් බර" value="<%= nTotWgtGold%>" name="nTotWgtGold" id="nTotWgtGold" onkeyup="calPrice()"  data="validate" data-type="weight"/>
                                                    </div> 
                                                ...
                                                <div id="hiddenDataDiv2" class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input  required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number"  placeholder="1g 1ක වටිනාකම" value="<%= nOneGramAssessedValue%>" name="nOneGramAssessedValue" id="nOneGramAssessedValue" onkeyup="calPrice()"  data="validate" data-type="decimal"/>
                                                    </div> 
                                                    <label class="col-sm-2 input-sm text-right">වෙළදපල වටිනාකම :</label>
                                                    <div class="col-md-4">
                                                        <input  required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number"  placeholder="වෙළදපල වටිනාකම" value="<%= nTotMkrtValue%>" name="nTotMkrtValue" id="nTotMkrtValue" maxlength="10" onclick="setMaxPriceForAdv();" onkeyup="setMaxPriceForAdv();" data="validate" data-type="decimal"/>
                                                    </div>
                                                ...
                                                <div id="hiddenDataDiv3" class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input  disabled type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number"  placeholder="තක්සේරු මුදල" value="<%= nTotAssessedValue%>" name="nTotAssessedValue"  id="nTotAssessedValue" data="validate" data-type="decimal"/>
                                                    </div> 
                                                ...
                                                <div id="hiddenDataDiv4" class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input  required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number"  placeholder="පොළි අනුපාතය" value="<%= nActualInt%>" name="nActualInt" id="nActualInt" data="validate" data-type="decimal"/>
                                                    </div> 
                                                    <label class="col-sm-2 input-sm text-right">එකග වූ පොළි අනුපාතය :</label>
                                                    <div class="col-md-4">
                                                        <input  required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number"  placeholder="එකග වූ පොළි අනුපාතය" value="<%=  nAgreedInt%>" name="nAgreedInt" id="nAgreedInt" data="validate" data-type="decimal"/>                                                        
                                                    </div> 
                                                ...
                                                <div id="hiddenDataDiv5" class="form-group">
                                                    ...
                                                    <div class="col-md-1 bg-pad">
                                                        <input required type="number" class="form-control input-sm number" id="nPwnPeriod" value="<%= nPwnPeriod%>" name="nPwnPeriod" onkeyup="onChangeNLPTypeIDLabel()" onchange="onChangeNLPTypeIDLabel()"  min="1" data="validate" data-type="number">                                                                                 
                                                    </div>
                                                ...
                                                <div  id="hiddenDataDiv6" class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input required type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha" value="<%= cReceiptNo%>" placeholder="කුයිතාන්සි අංකය" name="cReceiptNo" id="cReceiptNo" data="validate" data-type="number"/>
                                                    </div> 
                                                ...
                                                <div id="hiddenDataDiv7" class="form-group">                                                    
                                                    ...
                                                    <div class="col-md-4">
                                                        <input onkeypress='return ((event.which == 190) && (event.which < 48 || event.which > 57))' type="text" class="form-control input-sm col-lg-4 convertSinhalaIskolaPotha text-right number " placeholder="දැනට ශේෂය" value="<%= nBalAmount%>" name="nBalAmount" id="nBalAmount" data="validate" data-type="decimal"/>
                                                    </div> 
                                                ...
                                                <div id="hiddenDataDiv8" class="form-group"> 
                                                    ...
                                                    <div class="col-md-10">
                                                        ...
                                                        <textarea  style="min-height: 100px;" placeholder="වෙනත් විස්තර" name="cRemrks " id="cRemrks" class="form-control input-sm col-lg-3 convertSinhalaIskolaPotha"><%= cRemrks%></textarea>
                                                    </div> 
                                                </div>
                                                <!--New Article-->
        ...
        <script type="text/javascript">
            ...
            function calPrice() {
                ...
                while (nOneGramAssessedValue.search(",") >= 0) {
                    nOneGramAssessedValue = (nOneGramAssessedValue + "").replace(',', '');
                }
                while (nTotWgtGold.search(",") >= 0) {
                    nTotWgtGold = (nTotWgtGold + "").replace(',', '');
                }
