 ...
 * @author mmh
 */
public class LoanDetailsGetMasterDetilsServlet extends HttpServlet {
        ...
        try {
            ...
            switch (tellerIndexKey) {
                case "custCIFIDLoan":
                    ...
                    request.getSession().setAttribute("loanDetailsCheck", "on");
                    response.sendRedirect("LoanDetailsServlet");
                    break;
            }
        } catch (GeneralSecurityException ex) {
            Logger.getLogger(LoanDetailsGetMasterDetilsServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
