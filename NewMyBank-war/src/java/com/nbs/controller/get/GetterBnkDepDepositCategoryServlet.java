 ...
 * @author lasa
 */
public class GetterBnkDepDepositCategoryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       request.getSession().setAttribute("bnkDepDepositCategoryAll", bnkDepDepositCategoryDao.getAllBnkDepDepositCategory());
