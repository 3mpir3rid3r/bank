 ...
 * @author mmh
 */
public class GetSelectedAct4Detail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (dep.equals("on")) {
                ...
                request.getSession().setAttribute("actid", actId);
                response.sendRedirect("saving/saving_prototype.jsp?actId=" + actId + "");
                //request.getSession().setAttribute("checkSaving", "on");
            } else {
                response.sendRedirect("loan/loan_prototype.jsp?actId=" + actId + "");
            }
        }
    }
